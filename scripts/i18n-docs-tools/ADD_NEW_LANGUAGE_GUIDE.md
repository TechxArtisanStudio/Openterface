...
#### `lang.yml` (Primary Language Definition - Single Source of Truth)
...
- **Action Required**: No modification needed - reads from docs/assets/i18n-sites/lang.yml
...
#### `scripts/i18n-docs-tools/clean_file_variants.py`
...
#### `scripts/i18n-docs-tools/translation_guide/`
- **Location**: `/scripts/i18n-docs-tools/translation_guide/`
...
**Example:**
```bash
cp scripts/i18n-docs-tools/translation_guide/template.md scripts/i18n-docs-tools/translation_guide/ru.md
...
2. Update `docs/assets/i18n-sites/lang.yml` with the new language entry
...
1. Copy `scripts/i18n-docs-tools/translation_guide/template.md` to `scripts/i18n-docs-tools/translation_guide/{language_code}.md`
...
1. Run: `python scripts/i18n-docs-tools/workflow.py refresh`
...
|-----------|-------|-------|
| **Core Config** | 2 | `docs/assets/i18n-sites/lang.yml`, `mkdocs.yml` |
...
| **i18n Tools** | 6 | All scripts in `scripts/i18n-docs-tools/` directory |
| **Translation Guides** | 1+ | `scripts/i18n-docs-tools/translation_guide/{language_code}.md` |
