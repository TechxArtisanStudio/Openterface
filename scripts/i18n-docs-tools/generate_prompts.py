...
Default output dir: scripts/i18n-docs-tools/prompts/
Languages precedence: --languages > --config YAML > mkdocs.yml > defaults.

Usage:
  python3 scripts/i18n-docs-tools/generate_prompts.py --docs docs --config docs/assets/i18n-sites/i18n.yml
  python3 scripts/i18n-docs-tools/generate_prompts.py --docs docs --output-dir scripts/i18n-docs-tools/prompts --overwrite
...
def parse_args() -> argparse.Namespace:
    ...
    default_output_dir = os.path.join(script_dir, "prompts")
    default_guide_dir = os.path.join(script_dir, "translation_guide")
    parser.add_argument("--output-dir", default=default_output_dir, help="Directory to write prompt .txt files")
    parser.add_argument("--translation-guide-dir", default=default_guide_dir, help="Directory containing translation guides")
...
def build_prompt_markdown(
    ...
    lines.append("")
    lines.append("**IMPORTANT**: Follow the translation guidelines in the `scripts/i18n-docs-tools/translation_guide/` directory:")
    lines.append("")
    ...
    lines.append("- Follow guidelines in `scripts/i18n-docs-tools/translation_guide/` directory")
