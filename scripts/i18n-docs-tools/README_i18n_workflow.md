...
- **Read language config** directly from lang.yml
...
python scripts/i18n-docs-tools/workflow.py

# Show current status
python scripts/i18n-docs-tools/workflow.py status

# Run translation coverage audit
python scripts/i18n-docs-tools/workflow.py audit

# Generate LLM prompts for missing translations
python scripts/i18n-docs-tools/workflow.py prompts --overwrite

# Show detailed coverage report
python scripts/i18n-docs-tools/workflow.py report

# Show available translation guides
python scripts/i18n-docs-tools/workflow.py guides
```
...
python scripts/i18n-docs-tools/workflow.py report --only-missing

# Run audit and fail if missing translations found
python scripts/i18n-docs-tools/workflow.py audit --fail-on-missing
```
...
- ✅ Read language config from lang.yml
- ✅ Audit translation coverage  
- ✅ Generate LLM prompts
- ✅ Show coverage reports
- ✅ Quick actions and status

Simply run `python scripts/i18n-docs-tools/workflow.py refresh` instead of executing notebook cells.
