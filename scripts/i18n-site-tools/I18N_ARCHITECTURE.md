...
Both methods are governed by a **single source of truth**: `docs/assets/i18n-sites/lang.yml`
...
### Step 1: Update lang.yml (Single Source of Truth)

```bash
# Edit: docs/assets/i18n-sites/lang.yml
vim docs/assets/i18n-sites/lang.yml
```
...
```bash
vim scripts/i18n-site-tools/templates/about-base.html
```
...
python scripts/scripts/i18n-site-tools/generate_static_pages.py --template about

# Generate specific language
python scripts/scripts/i18n-site-tools/generate_static_pages.py --template about --language zh
```
...
1. ✅ **Always update lang.yml first** when adding languages
...
ls scripts/i18n-site-tools/templates/home-base.html
```
...
- **Static Generator:** See `scripts/i18n-site-tools/README.md`
- **Language Config:** See `docs/assets/i18n-sites/lang.yml`
- **Adding Languages:** See `scripts/i18n-docs-tools/ADD_NEW_LANGUAGE_GUIDE.md`
...
- 🎯 **Single source of truth** → `lang.yml`
