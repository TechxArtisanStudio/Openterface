...
class StaticPageGenerator:
    ...
    def __init__(self):
        ...
        self.i18n_dir = self.script_dir.parent.parent / "docs" / "assets" / "i18n-sites"
        self.output_dir = self.script_dir.parent.parent / "docs" / "overrides"
        self.partials_dir = self.script_dir.parent.parent / "docs" / "partials"
    ...
    def generate_hreflang_partial(self) -> None:
        """Generate docs/overrides/partials/hreflang.html from lang.yml."""
    ...
    def generate_template(self, template_name: str, language: str = None):
        ...
        if not supported_languages:
            raise ValueError(
                f"No common languages between lang.yml and {template_name}.json"
            )
