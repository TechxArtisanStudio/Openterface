...
class YouTubeWebsiteGenerator:
    ...
    def load_i18n_config() -> Dict:
        ...
        i18n_path = script_dir.parent.parent / "docs" / "assets" / "i18n-sites" / "videos.json"
    ...
    def load_video_card_template(self) -> str:
        """Load the video card template from scripts/youtube-tools directory."""
        script_dir = Path(__file__).parent
...
"""
    ...
    def validate_and_get_languages(self) -> List[str]:
        ...
        if not available_languages:
            raise ValueError(
                "No common languages between lang.yml and youtube-videos.json"
            )
    ...
    def generate_for_i18n_pipeline(self):
        ...
        print(f"\n💡 Next step:")
        print(f"   Run: python scripts/i18n-site-tools/generate_static_pages.py --template videos")
        print(f"   Or: python scripts/i18n-site-tools/generate_all_i18n.py")
...
Examples:
  ...
  # Then run: python scripts/i18n-site-tools/generate_static_pages.py --template videos
