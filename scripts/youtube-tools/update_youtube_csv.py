...
This script updates scripts/youtube-tools/youtube.csv with YouTube video metadata.
...
def main():
    parser = argparse.ArgumentParser(
        description='Update scripts/youtube-tools/youtube.csv with YouTube video metadata',
...
Examples:
  ...
  python update_youtube_csv.py --vpn
    ...
    parser.add_argument('--csv-path', 
                       help='Path to CSV file (default: scripts/youtube-tools/youtube.csv)',
                       type=Path)
    ...
    if args.csv_path:
        ...
        # Default to scripts/youtube-tools/youtube.csv (same directory as script)
