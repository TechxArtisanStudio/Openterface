...
私たちはオープンハードウェアとオープンソースソフトウェアにコミットしており、[GNU Affero General Public License v3](https://github.com/TechxArtisanStudio/Openterface_Android/blob/main/LICENSE)の下でライセンスされています。
