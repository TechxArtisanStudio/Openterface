...
-   ### :fontawesome-brands-linux:{ .lg } **Linux**
    ...
    ***
    ...
    [:octicons-download-24: Scarica {{qt_version}} ARM64 DEB](https://github.com/TechxArtisanStudio/Openterface_QT/releases/download/{{qt_version}}/openterfaceQT_linux_arm64.deb) <br>
    [:octicons-download-24: Scarica {{qt_version}} ARM64 AppImage](https://github.com/TechxArtisanStudio/Openterface_QT/releases/download/{{qt_version}}/openterfaceQT_linux_arm64.AppImage) <br>
    [:octicons-mark-github-16: Openterface_QT](https://github.com/TechxArtisanStudio/Openterface_QT) <br>
...
- Feb 03, 2026: [Suggerimento Copia/Incolla Ubuntu (macOS → Ubuntu)](updates/20260203-macos-ubuntu-copy-paste.it.md)
- Dec 18, 2025: [Velocità del mouse e prestazioni di gioco di Openterface Mini-KVM su macOS](updates/20251218-macos-mouse-speed.it.md)

[:octicons-arrow-right-24: Leggi altri aggiornamenti](/app/updates)
