---
title: Perguntas frequentes sobre Openterface KeyMod
description: Perguntas frequentes sobre KeyMod: recursos, compatibilidade, plataformas e informações de pré-lançamento.
