...
KeyMod Seriesコントローラーアプリは**Android**、**iOS**、**iPadOS**に焦点を当てています。Openterfaceエコシステム全体では、**WindowsとmacOS**のソフトウェアによるデスクトップコントロールの拡張も進めています。
...
はい。オープンソースのモバイルアプリは、カスタム入力プロファイル、マクロ、ホットキー、ワークフローショートカットをサポートしています。テンキーも使用できます。
