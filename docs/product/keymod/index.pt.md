...
-   :material-feature-search-outline:{ .lg } __Especificações e recursos__
    ...
    [:octicons-arrow-right-24: Ver recursos](/product/keymod/features)

    [:octicons-arrow-right-24: O que vem na caixa](/product/keymod/whats-in-the-box/)

    [:octicons-arrow-right-24: Como conectar](/product/keymod/how-to-connect/)
...
-   :material-power-plug:{ .lg } __Como usar__
    ...
    [:octicons-arrow-right-24: Ver perguntas frequentes](/product/keymod/faq)
...
-   :material-calendar-star:{ .lg } __Pré-lançamento e atualizações__
    ...
    [:material-newspaper-variant-outline: Atualizações do produto](/product/keymod/updates/) / [:material-play-circle-outline: Vídeos do YouTube](/videos/?p=keymod) / [:material-account-group-outline: Inscrever-se abaixo](/product/keymod/#product-signup-form)
...
- **Versão conector 2-em-1** — Design de plug USB A + USB C combinado para ampla compatibilidade com laptops, tablets e telefones
- **Versão USB C** — Plug USB C dedicado para dispositivos modernos e gerenciamento de cabos limpo

Ambas as variantes compartilham a mesma funcionalidade principal: teclado e mouse HID Bluetooth, perfis personalizados, macros e modos gamepad.
