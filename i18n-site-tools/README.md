...
```bash
python i18n-site-tools/generate_static_pages.py --template home --language zh
```
...
Create `i18n-site-tools/templates/your-page-base.html` with `data-i18n-key` attributes:
...
```bash
python i18n-site-tools/generate_static_pages.py --template your-page
```
...
vim i18n-site-tools/templates/home-base.html
...
git add i18n-site-tools/ docs/assets/i18n-sites/ docs/overrides/
...
Ensure template file exists: `i18n-site-tools/templates/your-template-base.html`
